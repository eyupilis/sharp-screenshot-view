...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ai_triage_results: {
        Row: {
          ...
          organization_id: string;
          suggested_severity: Database["public"]["Enums"]["severity_level"] | null;
      ...
      incidents: {
        Row: {
          ...
          ai_suggested_severity: Database["public"]["Enums"]["severity_level"] | null;
          approved_severity: Database["public"]["Enums"]["severity_level"] | null;
          category: string | null;
          created_at: string;
          created_by: string | null;
          description: string;
          ...
          reference: string;
          reported_severity: Database["public"]["Enums"]["severity_level"] | null;
    ...
    Enums: {
      app_role:
        "reporter" | "responder" | "manager" | "curator" | "tenant_admin" | "platform_admin";
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["reporter", "responder", "manager", "curator", "tenant_admin", "platform_admin"],
      freshness_status: ["valid", "needs_review", "stale", "deprecated"],
      incident_status: [
        "new",
        "triage_pending",
