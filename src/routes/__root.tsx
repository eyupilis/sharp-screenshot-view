  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Beklenmeyen bir hata oluştu. Yeniden deneyebilir veya ana sayfaya dönebilirsiniz.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "ResolveIQ — Finansal Incident Zekâsı" },
      {
        name: "description",
        content:
          "Finansal sistem incident'ları için kanıta dayalı AI triage ve kurumsal bilgi hafızası.",
      },
      { name: "author", content: "GTech Academy Concept Project" },
      { property: "og:title", content: "ResolveIQ — Finansal Incident Zekâsı" },
      {
        property: "og:description",
        content: "Kanıta dayalı AI triage ve kurumsal bilgi hafızası.",
      },
